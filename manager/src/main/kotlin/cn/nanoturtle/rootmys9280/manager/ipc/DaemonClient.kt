package cn.nanoturtle.rootmys9280.manager.ipc

import kotlinx.coroutines.Dispatchers
import kotlinx.coroutines.flow.StateFlow
import kotlinx.coroutines.withContext
import cn.nanoturtle.rootmys9280.ipc.IFrameworkInstallReceiver
...
class DaemonClient(private val serviceState: StateFlow<IManagerService?>) {
    ...
    suspend fun setModuleScope(
        packageName: String,
        applications: List<cn.nanoturtle.rootmys9280.ipc.ScopeEntry>,
    ...
    suspend fun getModuleScope(
        packageName: String
    ): Result<List<cn.nanoturtle.rootmys9280.ipc.ScopeEntry>> = runIpc {
    ...
    suspend fun getUsers(): Result<List<cn.nanoturtle.rootmys9280.ipc.DeviceUser>> = runIpc { it.users
    }
